...
export const AvatarAccountInfo = ({ onClick }) => {
  ...
  return (
    <AccountInfoHeader style={isMobileView ? { padding: '8px' } : null}>
      <Avatar src="https://yt3.ggpht.com/eCC-METHw9VDuS41kL4T5somaeSyJAkYNx3W3TSioVvpP1gNufa77FdUygXQ5eDDyy9t_Lhc1g=s88-c-k-c0x00ffffff-no-rj" />
      <Box>
        <AccountName>azamat-coding</AccountName>
        <AccountEmail>azamattoraboyev42@gmail.com</AccountEmail>
